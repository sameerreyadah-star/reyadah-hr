...
// Check if workTimings section already exists
if (content.includes("adminPage === 'workTimings'")) {
  console.log('workTimings section already exists');
  process.exit(0);
}

// Find the adminPage === 'holidays' section (the specific one at the admin section)
// Look for: adminPage === 'holidays' && h('div', { className: 'card admin-section-card' }
const marker = "adminPage === 'holidays' && h('div', { className: 'card admin-section-card' }";
const idx = content.indexOf(marker);

if (idx === -1) {
  console.log('Could not find holidays section marker');
  process.exit(1);
}
...
// Add the section before holidays
...
console.log('Done! Work Timings section added.');