...
['team', 'roles', 'workTimings', 'bulkUpload', 'leaveBalances', 'employeeLeave', 'applyLeave', 'faceRegister', 'assignAsset', 'assignShift', 'tickets', 'zkteco', 'biometric', 'reports', 'holidays', 'departments', 'auditLog', 'eos'].map((page) => h('button', {
              key: page,
