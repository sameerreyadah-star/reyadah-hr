...
['team', 'outlets', 'roles', 'workTimings', 'bulkUpload', 'leaveBalances', 'employeeLeave', 'applyLeave', 'faceRegister', 'assignAsset', 'assignShift', 'tickets', 'zkteco', 'biometric', 'reports', 'holidays', 'departments', 'auditLog', 'eos'].map((page) => h('button', {
              key: page,
            ...
            h('div', { className: 'emp-profile-content' }, [
              h('div', { className: 'card emp-profile-main' }, [
                ...
                h('div', { className: 'profile-detail-grid' }, [
                  ...
                  h('div', null, [h('p', { className: 'detail-label' }, 'Phone'), h('p', null, selectedEmployeeDetails.phone || '—')]),
                  h('div', null, [h('p', { className: 'detail-label' }, 'Nationality'), h('p', null, selectedEmployeeDetails.nationality || '—')]),
                  h('div', null, [h('p', { className: 'detail-label' }, 'Department / Outlet'), h('p', null, selectedEmployeeDetails.department || '—')]),
                  h('div', null, [h('p', { className: 'detail-label' }, 'Designation'), h('p', null, selectedEmployeeDetails.designation || '—')]),
                  h('div', null, [h('p', { className: 'detail-label' }, 'Role'), h('p', null, formatRole(selectedEmployeeDetails.role))]),
